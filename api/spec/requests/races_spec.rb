...
RSpec.describe "/races", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get races_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Race" do
        expect {
          post races_url,
               params: { race: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Race" do
        expect {
          post races_url,
               params: { race: invalid_attributes }, as: :json
        }.to change(Race, :count).by(0)
      end

      it "renders a JSON response with errors for the new race" do
        post races_url,
             params: { race: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested race" do
        race = Race.create! valid_attributes
        patch race_url(race),
              params: { race: new_attributes }, headers: valid_headers, as: :json
        race.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested race" do
      race = Race.create! valid_attributes
      expect {
        delete race_url(race), headers: valid_headers, as: :json
      }.to change(Race, :count).by(-1)
    end
  end
end
