...
class TraitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trait" do
    assert_difference("Trait.count") do
      post traits_url, params: { trait: { description: @trait.description, details: @trait.details, name: @trait.name } }, as: :json
    end
  ...
  test "should update trait" do
    patch trait_url(@trait), params: { trait: { description: @trait.description, details: @trait.details, name: @trait.name } }, as: :json
    assert_response :success
  end
